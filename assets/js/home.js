...
/* harmony import */ var _modules_CustomSwiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/CustomSwiper */ "./source/js/modules/CustomSwiper.js");
/* harmony import */ var _modules_CustomModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/CustomModal */ "./source/js/modules/CustomModal.js");



var customSwiper = new _modules_CustomSwiper__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
/***/ "./source/js/modules/CustomModal.js":
/*!******************************************!*\
  !*** ./source/js/modules/CustomModal.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CustomModal = /*#__PURE__*/function () {
  ...
  _createClass(CustomModal, [{
    ...
    value: function events() {
      var _this = this;
      var _iterator = _createForOfIteratorHelper(this.modalSuperiorityTriggers),
        _step;
      try {
        var _loop = function _loop() {
          var modalSuperiorityTrigger = _step.value;
          modalSuperiorityTrigger.addEventListener('click', function (event) {
            event.preventDefault();
            var modalImage = modalSuperiorityTrigger.dataset.image;
            var modalTitle = modalSuperiorityTrigger.dataset.title;
            var modalContent = modalSuperiorityTrigger.dataset.content;
            var dataModal = {
              modalImage: modalImage,
              modalTitle: modalTitle,
              modalContent: modalContent
            };
            _this.loadModalSuperiority(dataModal);
          });
        };
      ...
      var _iterator2 = _createForOfIteratorHelper(this.modalRegisterTriggers),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var modalRegisterTrigger = _step2.value;
          modalRegisterTrigger.addEventListener('click', function (event) {
            event.preventDefault();
            _this.loadModalRegister();
          });
        }
      } catch (err) {
        _iterator2.e(err);
    ...
    key: "loadModalSuperiority",
    value: function loadModalSuperiority(dataModal) {
      var modalSuperiorityImage = document.querySelector('#modalSuperiorityImage');
      var modalSuperiorityTitle = document.querySelector('#modalSuperiorityTitle');
      var modalSuperiorityContent = document.querySelector('#modalSuperiorityContent');
      ...
      var modalSuperiority = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal('#superiorityModal', {
        keyboard: false
      });
      modalSuperiority.show();
    }
  }, {
    key: "loadModalRegister",
    value: function loadModalRegister() {
      var modalRegister = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal('#registerModal', {
        keyboard: false
      });
      modalRegister.show();
    }
...
var CustomSwiper = /*#__PURE__*/function () {
  ...
  _createClass(CustomSwiper, [{
    ...
    value: function bannerSwiper() {
      var bannerSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".bannerSwiper", {
        spaceBetween: 0,
        effect: "fade",
        pagination: {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknisanterraventure_static"] = self["webpackChunknisanterraventure_static"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["assets/css/home","assets/css/layout"], () => (__webpack_require__("./source/js/home.js")))
